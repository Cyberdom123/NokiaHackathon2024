...
module ALGORITHM
  ...
  wire Enable_out4;
  reg signed [14:0] Rotation_Cell_8_out1_hold;  // sfix15_En12
  reg signed [14:0] Rotation_Cell_8_out2_hold;  // sfix15_En12
  ...
  always @(posedge clk)
    begin : X_Out_hold_process
      if (reset == 1'b1) begin
        Rotation_Cell_8_out1_hold <= 15'sb000000000000000;
      end
      else begin
        if (Enable_out4) begin
          Rotation_Cell_8_out1_hold <= Rotation_Cell_8_out1;
        end
      end
    end
  ...
  assign X_Out = Rotation_Cell_8_out1_hold;

  always @(posedge clk)
    begin : Y_Out_hold_process
      if (reset == 1'b1) begin
        Rotation_Cell_8_out2_hold <= 15'sb000000000000000;
      end
      else begin
        if (Enable_out4) begin
          Rotation_Cell_8_out2_hold <= Rotation_Cell_8_out2;
        end
      end
    end
  ...
  assign Y_Out = Rotation_Cell_8_out2_hold;
