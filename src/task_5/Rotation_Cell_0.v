// -------------------------------------------------------------
// 
// File Name: hdlsrc/cos_sin_CORDIC/Rotation_Cell_0.v
...
// -------------------------------------------------------------
// 
// Module: Rotation_Cell_0
// Source Path: cos_sin_CORDIC/DUT_CORDIC/ALGORITHM/Rotation _Cell_0
// Hierarchy Level: 2
// Model version: 2.31
// 
// -------------------------------------------------------------
...
module Rotation_Cell_0
  ...
  wire signed [16:0] Unary_Minus1_cast;  // sfix17_En13
  wire signed [16:0] Unary_Minus1_cast_1;  // sfix17_En13
  wire signed [15:0] Unary_Minus1_out1;  // sfix16_En13
  wire signed [15:0] Switch1_out1;  // sfix16_En13
  wire signed [16:0] Add_add_cast;  // sfix17_En13
  wire signed [16:0] Add_add_cast_1;  // sfix17_En13
  wire signed [16:0] Add_add_temp;  // sfix17_En13
  wire signed [14:0] Add_out1;  // sfix15_En12
  wire signed [16:0] Unary_Minus2_cast;  // sfix17_En13
  wire signed [16:0] Unary_Minus2_cast_1;  // sfix17_En13
  wire signed [15:0] Unary_Minus2_out1;  // sfix16_En13
  wire signed [15:0] Switch2_out1;  // sfix16_En13
  wire signed [16:0] Add1_add_cast;  // sfix17_En13
  wire signed [16:0] Add1_add_cast_1;  // sfix17_En13
  wire signed [16:0] Add1_add_temp;  // sfix17_En13
  ...
  assign Unary_Minus1_cast = {Y_In[15], Y_In};
  assign Unary_Minus1_cast_1 =  - (Unary_Minus1_cast);
  assign Unary_Minus1_out1 = Unary_Minus1_cast_1[15:0];


  assign Switch1_out1 = (Logical_Operator_out1 == 1'b0 ? Y_In :
              Unary_Minus1_out1);


  assign Add_add_cast = {X_In[15], X_In};
  assign Add_add_cast_1 = {Switch1_out1[15], Switch1_out1};
  assign Add_add_temp = Add_add_cast + Add_add_cast_1;
  assign Add_out1 = Add_add_temp[15:1];


  assign X_Out = Add_out1;

  assign Unary_Minus2_cast = {X_In[15], X_In};
  assign Unary_Minus2_cast_1 =  - (Unary_Minus2_cast);
  assign Unary_Minus2_out1 = Unary_Minus2_cast_1[15:0];


  assign Switch2_out1 = (Bit_Slice_out1 == 1'b0 ? X_In :
              Unary_Minus2_out1);


  assign Add1_add_cast = {Y_In[15], Y_In};
  assign Add1_add_cast_1 = {Switch2_out1[15], Switch2_out1};
  assign Add1_add_temp = Add1_add_cast + Add1_add_cast_1;
  assign Add1_out1 = Add1_add_temp[15:1];


  assign Y_Out = Add1_out1;

  assign Constant_out1 = 20'sb00101101000000000000;
